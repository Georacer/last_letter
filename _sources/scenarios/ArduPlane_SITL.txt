Scenario: Using last_letter as the Physics Simulator for ArduPlane SITL
=======================================================================

Follow the `ArduPlane SITL instructions <http://dev.ardupilot.com/wiki/setting-up-sitl-on-linux/>`_ to download and compile the ArduPlane code.

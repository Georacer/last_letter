 ...
 */
/*
 * Imported from SITL_gazebo master at 2020/10/30
 */
#include <vector>
#include <regex>
#include <thread>
...
#include <last_letter/msgbuffer.hpp>
...
public:
    ...
    inline bool GetReceivedActuator() { return received_actuator_; }

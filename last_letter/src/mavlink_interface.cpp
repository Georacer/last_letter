...
/**
 * @brief Poll for MAVLink messages coming from the PX4 SITL port
 * 
 * @return int
 * 0: Got a message successfully
 * 1: poll error
 * 2: poll timeout
 * 3: recvfrom error
 * 4: connection closed by client
 * 5: Got SIGINT and immediately closing
 *  
 */
int MavlinkInterface::pollForMAVLinkMessages()
{
    int return_code{0};
    if (gotSigInt_)
    {
